...
void gen_monsters(dungeon_t *d)
{
  ...
  for (i = 0; i < d->num_monsters; i++) {
    std::vector<monster_description> descVector = d->monster_descriptions;
    monster_description description = descVector[rand_range(0, descVector.size() - 1)];
    m = new npc(d, description);
